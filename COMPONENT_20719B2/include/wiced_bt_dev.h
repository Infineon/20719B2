...
enum wiced_bt_management_evt_e
{
    ...
    BTM_LPM_STATE_LOW_POWER,                        /**< Bluetooth device wake has been deasserted */
    BTM_BLE_REMOTE_CONNECTION_PARAM_REQ_EVT,        /**< LE remote connection parameter request. Reply using wiced_bt_l2cap_reply_ble_remote_conn_params_req and return WICED_BT_CMD_STORED to denote this event was handled. Event data:
                                                       wiced_bt_ble_rc_connection_param_req_t */
};
 ...
 *
 * Description     Application can invoke this function to configure a custom Bluetooth tx power table to
