...
CYW920719B2Q40EVB-01:
    40-QFN package, Arduino compatible headers, 9-axis motion sensor and
...
BT_DEVICE_ADDRESS
    ...
    for example 20719B20FFEE. By default, the SDK will set a BDA for your device
...
ENABLE_DEBUG
    ...
    CYW920719B2Q40EVB-01: PUART RX/TX signals are shared with SWDCK and SWDIO.
    Remove RX and TX jumpers on J10 when using SWD. PUART and SWD cannot be used
    simultaneously on this board unless these pins are changed from the default
    configuration.
...
> make PLATFORM=CYW920719B2Q40EVB-01 OTA_FW_UPGRADE=1 build
